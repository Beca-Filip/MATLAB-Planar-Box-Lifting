function COM = COM_nDOF_Tensor(q,L,M,CMP)
%COM_NDOF_TENSOR implements the forward kinematic equations of the center
%of mass of a nDOF planar manipulator for a vectorized input of joint
%angles. Returns the coordinate tensor COM of the center of mass along
%the trajectory.
%
%   COM = COM_NDOF_TENSOR(q, L, M, CMP) takes in the matrix of joint angles
...
COM = zeros(3, N);        % Prealocate output
...
for ii = 1 : N
    ...
    for jj = 1 : n
        ...
        R{jj} = rotz(rad2deg(sum(q(1:jj, ii))));
