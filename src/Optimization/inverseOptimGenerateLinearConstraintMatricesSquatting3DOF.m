function [A, b, Aeq, beq] = inverseOptimGenerateLinearConstraintMatricesSquatting3DOF(itpParam, optParam, modelParam)
%INVERSEOPTIMGENERATELINEARCONSTRAINTMATRICESSQUATTING3DOF generates the
%matrices of linear equalities and inequalities required by the squat
%optimization.
