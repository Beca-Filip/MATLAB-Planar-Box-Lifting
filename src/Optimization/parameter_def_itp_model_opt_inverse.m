%PARAMETER_DEF_ITP_MODEL_OPT_INVERSE is a script to be used to generate the
%parameters related to the optimization contained in structures itpParam, 
%modelParam and optParam. This script is to be used within the inverse
%optimization pipeline as it generates an interpolation with the same
%number of samples as the original trajectory.
