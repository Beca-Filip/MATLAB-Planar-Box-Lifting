...
% Add some necessary fields to modelParam
modelParam.CrunchTimePercentage = 0.5;
modelParam.CrunchNeckHeightPercentage = 0.85;
modelParam.CrunchHipHeightPercentage = 0.85;

% Create a symbolic variable
x = casadi.SX.sym('x', 1, 3*287);

% Push it through function
[C, Ceq, description] = allSamplesConstraintFunctions(x, timeParam, modelParam);