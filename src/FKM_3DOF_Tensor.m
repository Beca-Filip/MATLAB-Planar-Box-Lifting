function T = FKM_3DOF_Tensor(q,L)
%FKM_3DOF_TENSOR implements the forward kinematic equations of a 3DOF planar
...
%
%   T = FKM_3DOF_TENSOR(q, L) takes in the matrix of joint angles (3 x Number of
%   samples) alongside the 3D vector of segment lengths and returns T 
...
T = zeros(4, 4, 4, N);  % Prealocate output
