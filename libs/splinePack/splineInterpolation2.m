function coefficients = splineInterpolation2(x, y, p, boundaryConditions)
%SPLINEINTERPOLATION2 approximates a function using a piece-wise polynomial
%representation and gives back the coefficients of said polynomials.
%
%   coefficients = SPLINEINTERPOLATION2(x, y, p, boundaryConditions)
%   gives back the coefficients of polynomials of a given order p
