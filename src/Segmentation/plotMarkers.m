%PLOTMARKERS loads the Marker data of the human squat movement collection,
%and plots them in an animation. Blue for Markers on the right side
%(annotated with a prefix R), Red for Markers on the left side (annotated
%with a prefix L) and green for other Markers.
