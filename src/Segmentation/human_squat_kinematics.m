%HUMAN_SQUAT_KINEMATICS loads the 7DOF kinematic data of the human
%squatting model. It performs a transformation defined by an anonymous
%function dof7to3, to transform the 7DOF model to an equivalent 3DOF model
%in the plane, with joints in the ankle, knee and hip. 
%Model parameters are loaded from Charlotte (segment lengths, inertias and
%masses).
%The model is then animated for the whole duration of the movement
%collection.
